...
class CkyViterbi(object):
    ...
    def read_dev_parses(self):
        parses = open(os.getcwd() + '/part3/output/dev.parses.post')
        for line in parses.readlines():
            self.dev_parses.append(line)
    def read_test_parses(self):
        parses = open(os.getcwd() + '/part3/output/test.parses.post')
        for line in parses.readlines():
            self.test_parses.append(line)
